...
# from utils.quaternion_math import process_poses
from utils.quaternion_math import RT2QT
...
class SevenScenes(data.Dataset):
    def __init__(self, scene, data_path, train, transform=None,
        ...
        data_dir = osp.join(filedir, '..', 'datasets',
                            'data', '7Scenes', scene)
        ...
        for seq in seqs:
            ...
            p_filenames = [n for n in os.listdir(osp.join(seq_dir, '.')) if
                           n.find('pose') >= 0]
            # if real:  # SLAM/integration of VO
